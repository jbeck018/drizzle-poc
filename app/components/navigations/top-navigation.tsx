...
export function TopNavigation({ user, plan_id }: NavigationProps) {
              ...
              <Button
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="flex h-5 items-center rounded-full bg-primary/10 px-2 text-xs font-medium text-primary/80">
                    {(plan_id && plan_id.charAt(0).toUpperCase() + plan_id.slice(1)) ||
                      'Free'}
                  </span>
                </div>
